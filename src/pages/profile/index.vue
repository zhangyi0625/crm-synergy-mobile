...
<template>
  <view class="profile">
    <view class="profile-title bg-dull-red flex align-center">
      <img src="../static/images/avatar.png" class="w-112 h-112 br-half" />
      <view class="ml-20 font500 font40 neutral" @click="handleLogin"
        >{{ !isLogin ? "登录/注册" : "13120760853" }}
      </view>
    </view>
    <view class="profile-content px-24">
      <view class="br16 bg-neutral">
        <view
          class="flex align-center flex-between font400 font28 dull-grey px-24 py-32"
        ...
        >
          ...
          <view class="flex align-center">
            <view class="font26 light-grey">用户名</view>
          </view>
        </view>
      </view>
