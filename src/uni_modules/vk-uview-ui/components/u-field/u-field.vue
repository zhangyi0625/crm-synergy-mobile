<template>
	<view class="u-field" :class="{ 'u-border-top': borderTop, 'u-border-bottom': borderBottom }">
		<view class="u-field-inner" :class="[
			...
			<view class="fild-body">
				<view class="u-flex-1 u-flex" :style="[inputWrapStyle]">
					<textarea v-if="type == 'textarea'" class="u-flex-1 u-textarea-class" :style="[fieldStyle]"
						:value="valueCom" :placeholder="placeholder" :placeholderStyle="placeholderStyle"
						...
						@tap="fieldClick" />
					<input v-else :style="[fieldStyle]" :type="type" class="u-flex-1 u-field__input-wrap"
						:value="valueCom" :password="password || type === 'password'" :placeholder="placeholder"
				...
				<u-icon :size="clearSize" v-if="clearable && valueCom != '' && focused" name="close-circle-fill"
