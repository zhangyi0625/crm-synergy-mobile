<template>
	<u-popup class="" :blur="blur" :mask="mask" :maskCloseAble="maskCloseAble" mode="bottom" :popup="false"
		v-model="popupValue" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="popupClose"
		:zIndex="uZIndex">
		<slot />
		...
		<block v-else>
			<u-car-keyboard ref="uCarKeyboard" :random="random" @backspace="backspace"
