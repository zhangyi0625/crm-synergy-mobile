...
const _sfc_main = {
  ...
  methods: {
    ...
    // 查询tab的布局信息
    getTabRect() {
      let query = common_vendor.i.createSelectorQuery().in(this);
    ...
    scrollByIndex() {
      ...
      this.scrollBarLeft = left - common_vendor.i.upx2px(this.barWidth) / 2;
...
if (!Array) {
  const _easycom_u_badge2 = common_vendor.v("u-badge");
  _easycom_u_badge2();
}
...
const Component = /* @__PURE__ */ common_vendor.q(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-5cf5aad8"], ["__file", "/Users/zhangyi/Desktop/vue/vue3/Vue3-Vite-TS-uniapp freight- system/src/uni_modules/vk-uview-ui/components/u-tabs/u-tabs.vue"]]);
