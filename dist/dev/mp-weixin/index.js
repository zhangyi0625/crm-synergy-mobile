      ...
      return common_vendor.B({
        ...
        b: common_vendor.F(props.data, (item, index, i0) => {
          return common_vendor.B({
            ...
            t: common_vendor.N(item.tag === "强推" ? "background: #FF844A" : "background: #FFB23F")
          } : {}, {
        ...
        c: common_vendor.F(props.data, (item, index, i0) => {
          var _a, _b, _c;
          return common_vendor.B({
            a: item.carrierCode !== common_vendor.C(enums_freight.P).QMS && !__props.isRoute && item.products.length > 0
          }, item.carrierCode !== common_vendor.C(enums_freight.P).QMS && !__props.isRoute && item.products.length > 0 ? common_vendor.B({
            ...
            m: common_vendor.F(item.products, (el, elIndex, i1) => {
              ...
              return common_vendor.B(__props.isRoute && item.products.length > 0 ? {
                a: common_vendor.H((_a2 = el.por) == null ? void 0 : _a2.cnName),
                b: common_vendor.H((_b2 = el.por) == null ? void 0 : _b2.enName),
                c: common_vendor.H((_c2 = el.fnd) == null ? void 0 : _c2.cnName),
                d: common_vendor.H((_d = el.fnd) == null ? void 0 : _d.enName)
              } : {}, {
                ...
                y: common_vendor.N(el.tag === "强推" ? "background: #FF844A" : "background: #FFB23F")
              } : {}, {
            ...
            n: __props.isRoute && item.products.length > 0,
            o: common_vendor.I(__props.isRoute && item.products.length > 0 ? "mt-20" : ""),
            p: common_vendor.I(__props.isRoute && item.products.length > 0 ? "mb-20 pb-0" : "")
          } : {}, {
            q: index
          });
        })
        ...
        e: common_vendor.D(refreshFreight)
      } : {});
    };
  }
});
const MiniProgramPage = /* @__PURE__ */ common_vendor.q(_sfc_main, [["__scopeId", "data-v-3134b717"], ["__file", "/Users/zhangyi/Desktop/vue/vue3/Vue3-Vite-TS-uniapp freight- system/src/pagesA/freight/component/freight-table/index.vue"]]);
exports.M = MiniProgramPage;
