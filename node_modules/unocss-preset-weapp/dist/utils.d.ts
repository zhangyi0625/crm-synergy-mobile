...
export { C as CONTROL_MINI_NO_NEGATIVE, c as colorResolver, a as colorableShadows, d as directionSize, g as getBracket, e as getComponent, f as getComponents, h as hasParseableColor, m as makeGlobalStaticRules, p as parseColor, r as resolveBreakpoints, b as resolveVerticalBreakpoints, s as splitShorthand } from './utilities-69da0e05.js';
import './types-9f3d77d6.js';
...
declare const handler: _unocss_core.ValueHandler<"number" | "auto" | "position" | "numberWithUnit" | "rem" | "remToRpx" | "rpx" | "px" | "percent" | "fraction" | "bracket" | "bracketOfColor" | "bracketOfLength" | "bracketOfPosition" | "cssvar" | "time" | "degree" | "global" | "properties">;
declare const h: _unocss_core.ValueHandler<"number" | "auto" | "position" | "numberWithUnit" | "rem" | "remToRpx" | "rpx" | "px" | "percent" | "fraction" | "bracket" | "bracketOfColor" | "bracketOfLength" | "bracketOfPosition" | "cssvar" | "time" | "degree" | "global" | "properties">;

declare const variantMatcher: (name: string, handler: (input: VariantHandlerContext) => Record<string, any>, transformRules?: Record<string, string>) => VariantObject;
declare const variantParentMatcher: (name: string, parent: string, transformRules?: Record<string, string>) => VariantObject;
