export { c as colors } from './colors-97e5c3b6.js';
export { t as theme } from './default-70d73d52.js';
import { T as Theme } from './types-9f3d77d6.js';
export { C as Colors, a as ThemeAnimation } from './types-9f3d77d6.js';
import '@unocss/core';
...
export { Theme, animation, baseSize, blur, borderRadius, boxShadow, breakpoints, containers, dropShadow, duration, easing, fontFamily, fontSize, height, letterSpacing, lineHeight, lineWidth, maxHeight, maxWidth, preflightBase, ringWidth, spacing, textIndent, textShadow, textStrokeWidth, verticalBreakpoints, width, wordSpacing };
