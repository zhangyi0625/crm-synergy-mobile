...
const colors = require('./shared/unocss-preset-weapp.a5e17ac7.cjs');
const _default = require('./shared/unocss-preset-weapp.c88a7495.cjs');
require('./shared/unocss-preset-weapp.7ca86f21.cjs');
require('./shared/unocss-preset-weapp.51ea3303.cjs');
require('@unocss/core');
