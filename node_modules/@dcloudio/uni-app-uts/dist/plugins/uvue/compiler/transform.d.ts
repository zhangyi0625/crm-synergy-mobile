...
export declare function createTransformContext(root: RootNode, { targetLanguage, filename, prefixIdentifiers, nodeTransforms, directiveTransforms, isBuiltInComponent, isCustomElement, onError, onWarn, }: TransformOptions): TransformContext;
