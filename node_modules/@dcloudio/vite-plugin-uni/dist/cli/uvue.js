...
exports.buildUVue = exports.runUVueDev = exports.initUVueEnv = void 0;
...
async function runUVueDev(options) {
    ...
    watcher.on('event', (event) => {
        if (event.code === 'BUNDLE_START') {
            ...
            return (0, uni_cli_shared_1.output)('log', uni_cli_shared_1.M['dev.watching.end.files'].replace('{files}', JSON.stringify(['classes.dex'])));
